...
export default function RegisterPage() {
  ...
  const { register, loading, error, registrationSuccess } = useRegister();
  const {
    loginWithGithub,
    loading: githubLoading,
    error: githubError,
  } = useGithubAuth('/movements');
  ...
  if (registrationSuccess) {
    return <RegistrationSuccess email={form.email} />;
  }
      ...
      <div className='max-w-md w-full'>
        ...
        <Card className='p-8'>
          ...
          <div className='mt-6'>
            ...
            >
              {githubLoading ? 'Conectando con GitHub...' : 'GitHub'}
            </Button>
          </div>
